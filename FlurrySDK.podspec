...
Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'https://github.com/schurik/FlurrySDK.git', :tag => "#{s.version}" }
  s.platform = :ios
  ...
  s.subspec 'FlurrySDK' do |ss|
    ...
    ss.vendored_libraries = 'Flurry/libFlurry_6.2.0.a'
  end

  s.subspec 'FlurryAds' do |ss|
    ss.source_files = 'FlurryAds/**/*.h'
    ss.frameworks = 'iAd'
    ss.vendored_libraries = 'FlurryAds/libFlurryAds_6.2.0.a'
